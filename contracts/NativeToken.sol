...
contract NativeToken is ERC20, Ownable {
    ...
    function mintFor(
        ...
        _moveDelegates(address(0), _delegates[_address], _amount);
        return true;
    }
    ...
    function delegateBySig(
        ...
        require(block.timestamp <= expiry, "Native::delegateBySig: signature expired");
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Native tokens (not scaled);
